...
internal interface IInt128Ex<TSelf>
   where TSelf : IInt128Ex<TSelf>
{

  /// <summary>
  /// Returns a Instance from Int128Ex
  /// </summary>
  /// <param name="bytes">Preset bits.</param> 
  /// <param name="littleendian">Preset Endians of the bytes (bits).</param> 
  public abstract static TSelf ToInt128Ex(ReadOnlySpan<byte> bytes, bool littleendian = true);
  ...
  public abstract static TSelf ToInt128Ex(ReadOnlySpan<uint> uints, bool littleendian = true);
  ...
  public abstract static TSelf ToInt128Ex(ReadOnlySpan<ulong> ulongs, bool littleendian = true);
