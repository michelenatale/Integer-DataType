...
internal interface IUInt256Ex<TSelf>
   where TSelf : IUInt256Ex<TSelf>
{

  /// <summary>
  /// Returns a Instance from UInt256Ex
  /// </summary>
  /// <param name="bytes">Preset bits.</param> 
  /// <param name="littleendian">Preset Endians of the bytes (bits).</param> 
  public abstract static TSelf ToUInt256Ex(ReadOnlySpan<byte> bytes, bool littleendian = true);
  ...
  public abstract static TSelf ToUInt256Ex(ReadOnlySpan<uint> uints, bool littleendian = true);
  ...
  public abstract static TSelf ToUInt256Ex(ReadOnlySpan<ulong> ulongs, bool littleendian = true);
