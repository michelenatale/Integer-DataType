...
internal interface IInt256Ex<TSelf>
   where TSelf : IInt256Ex<TSelf>
{

  /// <summary>
  /// Returns a Instance from Int256Ex
  /// </summary>
  /// <param name="bytes">Preset bits.</param> 
  /// <param name="littleendian">Preset Endians of the bytes (bits).</param> 
  public abstract static TSelf ToInt256Ex(ReadOnlySpan<byte> bytes, bool littleendian = true);
  ...
  public abstract static TSelf ToInt256Ex(ReadOnlySpan<uint> uints, bool littleendian = true);
  ...
  public abstract static TSelf ToInt256Ex(ReadOnlySpan<ulong> ulongs, bool littleendian = true);
