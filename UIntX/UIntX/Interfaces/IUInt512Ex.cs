...
internal interface IUInt512Ex<TSelf>
   where TSelf : IUInt512Ex<TSelf>
{

  /// <summary>
  /// Returns a Instance from UInt512Ex
  /// </summary>
  /// <param name="bytes">Preset bits.</param> 
  /// <param name="littleendian">Preset Endians of the bytes (bits).</param> 
  public abstract static TSelf ToUInt512Ex(ReadOnlySpan<byte> bytes, bool littleendian = true);
  ...
  public abstract static TSelf ToUInt512Ex(ReadOnlySpan<uint> uints, bool littleendian = true);
  ...
  public abstract static TSelf ToUInt512Ex(ReadOnlySpan<ulong> ulongs, bool littleendian = true);
