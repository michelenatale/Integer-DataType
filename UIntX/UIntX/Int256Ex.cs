...
public readonly struct Int256Ex : IUIntXEx<Int256Ex>, IInt256Ex<Int256Ex>
{
  ...
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public static uint[] BitwiseNot(in uint[] value)
  {
    //Complement 
  ...
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public static uint[] BitwiseOr(uint[] left, uint[] right, int typesize)
  {
  ...
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public static uint[] BitwiseXor(uint[] left, uint[] right, int typesize)
  {
    var result = new uint[typesize];
    for (var i = 0; i < typesize; i++)
      result[i] = left[i] ^ right[i];
...
;
  ...
  {
    var ui256 = UInt256Ex.Pow(Abs(value).LOHI, exp);
    var result = (Int256Ex)ui256;
  ...
  public static explicit operator checked decimal(Int256Ex value)
  {
    ...
    if (value.Sign == -1)
    {
      value = -value;
      tmp = -(double)(UInt256Ex)value;
      if (tmp > pow_2_127n) return -(decimal)(UInt256Ex)value;
    }
    else
    {
      tmp = (double)(UInt256Ex)value;
      if (tmp > pow_2_127) return (decimal)(UInt256Ex)value;
    }
    throw new NotImplementedException();
  }
  ...
  public static explicit operator checked float(Int256Ex value)
  {
    ...
    if (value.Sign == -1)
    {
      value = -value;
      tmp = -(double)(UInt256Ex)value;
      if (tmp > pow_2_127n) return -(float)(UInt256Ex)value;
    }
    else
    {
      tmp = (double)(UInt256Ex)value;
      if (tmp > pow_2_127) return (float)(UInt256Ex)value;
    }
    throw new NotImplementedException();
  }
